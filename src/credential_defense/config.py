    ...
    return {
        ...
        "pricing": {
            ...
            "feature_access": {
                ...
                "family_child": {
                    "credential_records_limit": 80,
                    "queue_actions_limit": 8,
                    "breach_scans_per_day": 5,
                    "continuous_scan_enabled": False,
                    "overlay_assistant_enabled": False,
                    "rotation_queue_enabled": True,
                    "ai_hotline_enabled": False,
            ...
            "family_age_protocols": {
                "enabled": True,
                "graduation_age": 18,
                "parent_controls_plan_opt_out": True,
                "groups": [
                    {
                        ...
                        "min_age": 0,
                        "max_age": 12,
                        "allow_stored_credential_copy": False,
                        "allow_overlay_assistant": False,
                        "require_guardian_approval_for_sensitive_actions": True,
                    },
                    {
                        "code": "guided_13_15",
                        "label": "Guided 13-15",
                    ...
                    },
                    {
                        ...
                        "min_age": 16,
                        "max_age": 17,
                        "allow_stored_credential_copy": True,
                        "allow_overlay_assistant": True,
                        "require_guardian_approval_for_sensitive_actions": True,
                    },
                    {
                        ...
                        "allow_stored_credential_copy": True,
                        "allow_overlay_assistant": True,
                        "require_guardian_approval_for_sensitive_actions": False,
                    },
                ],
            },
            "lifetime_pro": {
        ...
        "hygiene": {
            ...
            "completed_queue_retention_days": 30,
            "storage_pressure_threshold_mb": 2048,
            "cache_cleanup_threshold_mb": 64,
        },
        "copilot": {
            "connected_ai": {
                "enabled": True,
                "allow_user_subscription_link": True,
                "require_explicit_action_confirmation": True,
                "provider_allowlist": ["openai"],
                "model_allowlist": ["gpt-4.1-mini", "gpt-4o-mini", "gpt-4.1"],
                "max_actions": 4,
                "block_core_mutation_intents": True,
                "defensive_scope_only": True,
        ...
        "integration_mesh": {
            ...
            "feature_flags": {
                ...
                "digital_key_risk_adapter": {
                    ...
                    "required_scopes": [
                        "digital_key:advisory",
                        "digital_key:high_risk_prompt",
                    ],
                    "require_redemption_proof": True,
                },
            },
            ...
            "connectors": {
                ...
                "digital_keys": {
                    ...
                    "require_parent_approval_for_remote_commands": True,
                    "require_lock_screen_for_high_risk_actions": True,
                    "require_biometric_for_high_risk_actions": True,
                    "require_strong_integrity_for_high_risk_actions": True,
                    "block_high_risk_actions_on_elevated_integrity": False,
                    "wallet_setup_guidance": [
                        {
                            "id": "google_wallet",
                            "label": "Google Wallet",
                        ...
                        },
                        {
                            ...
                            "package_names": ["com.samsung.android.spay"],
                            "setup_uri": "https://www.samsung.com/us/support/mobile/mobile-wallet/",
                            "fallback_uri": "https://galaxystore.samsung.com/prepost/000005790062?langCd=en",
                        },
                    ],
                    "manufacturer_setup_guidance": [
                        {
                            "id": "hyundai_digital_key",
                            "label": "Hyundai Digital Key",
                            "package_names": ["com.hyundaiusa.bluelink"],
                            "setup_uri": "https://owners.hyundaiusa.com/us/en/resources/technology-and-navigation/introducing-all-new-digital-key",
                            "fallback_uri": "https://play.google.com/store/search?q=hyundai%20bluelink&c=apps",
                        },
                        {
                            "id": "kia_connect_digital_key",
                            "label": "Kia Connect",
                            "package_names": ["com.myuvo.link"],
                            "setup_uri": "https://owners.kia.com/content/owners/en/uvo-link.html",
                            "fallback_uri": "https://play.google.com/store/search?q=kia%20connect&c=apps",
                        },
                        {
                            "id": "bmw_digital_key",
                            "label": "BMW Digital Key",
                            "package_names": ["de.bmw.connected.mobile20.na"],
                            "setup_uri": "https://www.bmwusa.com/explore/connecteddrive.html",
                            "fallback_uri": "https://play.google.com/store/search?q=bmw%20connected&c=apps",
                        },
                    ],
                },
            },
