    ...
    def _run_credential_defense_breach_first_flow(self) -> None:
        ...
        source_rules = {
            ...
            STRINGS_PATH: [
                ...
                "autofill_guide_autofill_path_miui_google_fallback",
                ...
                "adaptive_guide_resume_last_step",
                "adaptive_guide_restart_guided_route",
                "adaptive_guide_last_guided_step_template",
                "adaptive_guide_unavailable",
                "breach_scan_seed_prompt_title",
                "home_tutorial_step_credentials_window_body",
            ],
            ANDROID_DIR / "app" / "src" / "main" / "java" / "com" / "realyn" / "watchdog" / "FoundationGuidePlanner.kt": [
                "object FoundationGuidePlanner",
                "FoundationGuideTarget",
                "autofill_guide_autofill_path_miui_google_fallback",
                "autofill_guide_step_select_provider_miui",
                "autofill_guide_step_return",
            ],
            ...
            ANDROID_DIR / "app" / "src" / "main" / "java" / "com" / "realyn" / "watchdog" / "IncidentGuideOverlayService.kt": [
                "class IncidentGuideOverlayService",
                "guideForegroundActive",
                "startForeground(WatchdogConfig.INCIDENT_GUIDE_NOTIFICATION_ID, notification)",
                "stopForeground(STOP_FOREGROUND_REMOVE)",
            ...
            ANDROID_DIR / "app" / "src" / "test" / "java" / "com" / "realyn" / "watchdog" / "AdaptiveGuideSessionStoreTest.kt": [
                "encode decode roundtrip preserves structured session metadata",
                "resolve restores current and confirmed states from persisted metadata",
